...
var decisionReasonDescriptions = map[string]string{
	...
	"catch_correction_not_sustained":   "Free-path correction did not persist across enough samples",
	...
	"catch_possible_contact":           "Swept disc path approached a sampled hand, head or body; comparison discarded",
