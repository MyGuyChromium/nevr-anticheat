...
var decisionReasonDescriptions = map[string]string{
	...
	"catch_phase_changed":                    "Play became inactive before catch confirmation; the old approach cannot carry into the next phase",
	...
	"invalid_disc":                           "Non-finite reported disc data was excluded by input validation; no disc mechanics conclusion is available for this sample",
	"disc_out_of_range":                      "Reported disc position or speed exceeded input-sanity bounds and the disc sample was excluded; this is not a cheating verdict",
	"invalid_disc_observation":               "Reported disc attachment or observation metadata was invalid; dependent mechanics remain unavailable",
	...
	"release_speed_unusable":                 "Sampled disc motion, release timing or the configured speed reference was unavailable or invalid",
	"release_speed_roster_unavailable":       "Fresh player snapshots did not cover the complete sampled roster; release-speed corroboration is unavailable",
	"release_speed_release_replaced":         "A newer release ended the earlier sampled-speed window before corroboration",
	"release_speed_thrower_unavailable":      "The recorded thrower had no fresh sample; the release-speed window remains uncorroborated",
	"release_speed_source_unavailable":       "Bound source and timing context was unavailable for the sampled-speed comparison",
	"release_speed_source_changed":           "The recording source changed; earlier and later speed samples were not combined",
	"release_speed_first_sample_unavailable": "The original first-free disc snapshot was unavailable for multi-sample corroboration",
	"release_speed_first_sample_conflict":    "The published release and retained first-free snapshot disagreed; sampled-speed corroboration was withheld",
	"release_speed_attachment_unknown":       "Disc state or explicit attachment was missing or ambiguous; free flight was not inferred",
	"release_speed_attachment_conflict":      "Explicit attachment and other possession fields disagreed; sampled-speed corroboration was withheld",
	"release_speed_disc_held":                "The disc was recorded as held before speed corroboration; an attached sample is not free-flight evidence",
	"release_speed_motion_unavailable":       "Disc position, velocity or sampled time was invalid or unavailable; the speed window remains uncorroborated",
	"release_speed_snapshot_conflict":        "Player snapshots disagreed about disc state, time or source; no shared speed observation was assumed",
	"release_speed_conflicting_duplicate":    "Different observations used the same sampled frame; neither was counted as an additional free-flight sample",
	"release_speed_sample_gap":               "A frame or time discontinuity interrupted the consecutive sampled-speed window",
	"release_speed_contact_unavailable":      "A usable bounce counter was unavailable; sampled-speed corroboration was withheld",
	"release_speed_contact_observed":         "The reported bounce counter changed; observations across that contact were not combined as release-speed evidence",
	"release_speed_contact_possible":         "Possible head contact or an existing trajectory contact filter interrupted sampled-speed corroboration; the cause is unresolved",
	"release_speed_inactive_phase":           "The game left active play before speed corroboration; pending observations remain uncorroborated",
	"release_speed_end_of_stream":            "The recording ended before enough consecutive free-disc samples supported speed corroboration",
	"release_speed_insufficient_samples":     "Too few qualifying free-disc samples were available; an above-reference observation is retained without corroboration",
	"release_speed_not_sustained":            "Not all three sampled speeds exceeded the configured reference; any above-reference observation remains uncorroborated",
	"release_speed_three_samples_above_cap":  "Three consecutive known-free sampled speeds exceeded the configured reference; this does not prove exact launch speed or a gameplay violation",
	"engine_throw_available":                 "Valid attributed engine last_throw measurement was available",
	"engine_player_velocity_unavailable":     "No release-interval engine-reported player velocity was available; position-difference movement is descriptive context only",
	"hand_ratio_unavailable":                 "Hand kinematics were unavailable for speed-ratio evidence",
	"hand_ratio_above_context_limit":         "The sampled disc-to-hand speed ratio exceeded its contextual limit; the ratio does not increase release-speed severity",
	"sampled_speed_artifact_band":            "Sampled speed entered the suspected-artifact observation branch",
	"release_at_or_below_cap":                "Retained sampled speeds and any bound local report did not exceed the configured effective reference; this is not a clean-player verdict",
	"release_above_cap":                      "At least one reported speed exceeded the configured effective reference; sample support and source limitations determine its review status",
	...
	"release_measurement_inconsistent":       "Sampled release vectors, cached measurements or attribution confidence contradict each other",
