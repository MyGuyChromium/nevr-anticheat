...
func NewState005(params map[string]any) *State005 {
	d := &State005{
		...
		minCooldownFrames: detect.GetInt(params, "min_cooldown_frames",
			detect.GetInt(params, "cooldown_bypass_threshold_frames", 60)),
		minViolations: detect.GetInt(params, "min_violations",
			detect.GetInt(params, "min_violations_to_surface", 15)),
