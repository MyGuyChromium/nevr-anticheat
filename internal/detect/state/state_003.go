...
func NewState003(params map[string]any) *State003 {
	d := &State003{
		...
		suspiciousFrames:  detect.GetInt(params, "suspicious_frames", 120),
		highFrames:        detect.GetInt(params, "high_frames", 180),
		impossibleFrames:  detect.GetInt(params, "impossible_frames", 300),
