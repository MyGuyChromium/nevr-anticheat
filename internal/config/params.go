...
var detectorSpecs = map[string]DetectorSpec{
	...
	"MOV_001": {ID: "MOV_001", Name: "Impossible Player Speed", Category: "movement",
		Params: []ParamSpec{
			f("max_legitimate_speed", 12.0, "m/s", "sustained (median) speed above which movement is impossible; burst cap is max(this, physics.max_player_speed)"),
			i("sustained_speed_window", 10, "frames", "median window length"),
	...
	"MOV_002": {ID: "MOV_002", Name: "Teleportation", Category: "movement",
		Params: []ParamSpec{
			f("teleport_threshold", 5.0, "m", "position jump between consecutive frames that counts as a teleport"),
	...
	"MOV_005": {ID: "MOV_005", Name: "Boost Spam", Category: "movement",
		Params: []ParamSpec{
			...
			i("max_boosts_per_window", 8, "count", "boost activations allowed per window", "max_boosts_per_10s"),
	...
	"STATE_001": {ID: "STATE_001", Name: "Impossible Grab Distance", Category: "state",
		Params: []ParamSpec{
			...
			f("closing_velocity_scale", 0, "s", "latency credited to closing speed; 0 = use the frame dt"),
	...
	"STATE_002": {ID: "STATE_002", Name: "Stun Recovery Exploit", Category: "state",
		Params: []ParamSpec{
			i("min_stun_frames", 30, "frames", "shortest legitimate stun, converted to seconds with the match tick rate"),
	...
	"PAT_001": {ID: "PAT_001", Name: "Frame-Perfect Timing", Category: "pattern",
		Params: []ParamSpec{
			i("min_throw_count", 8, "count", "throws needed before inter-throw timing is evaluated (clamped to [3, 50])"),
	...
	"PAT_002": {ID: "PAT_002", Name: "Identical Release Points", Category: "pattern",
		Params: []ParamSpec{
			i("min_throw_count", 8, "count", "throws needed before release spread is evaluated"),
			f("min_release_spread", 0.02, "m", "body-frame release spread below which points are identical"),
